...
public class AuthorizedActivity extends Activity {
    private static final String LOG_TAG = AuthorizedActivity.class.getSimpleName();
    ...
    protected void onResume(){
        super.onResume();
        mAdapter = new TransactionListAdapter(this, TransactionListAdapter.TransactionListType.AUTHORIZED_TRANSACTION_LIST);
        mAdapter.addItems(LocalPreferences.getAuthorizedTransactionRecordList());
