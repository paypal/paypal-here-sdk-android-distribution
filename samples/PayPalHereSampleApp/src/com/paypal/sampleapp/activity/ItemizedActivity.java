...
public class ItemizedActivity extends MyActivity implements CardReaderListener {
    ...
    private void initStoreItems() {
        ...
        mStoreItems.put("Apple", DomainFactory.newInvoiceItem(("Apple"), new BigDecimal("4.12")));
        mStoreItems.put("Banana", DomainFactory.newInvoiceItem(("Banana"), new BigDecimal("1.32")));
        mStoreItems.put("Orange", DomainFactory.newInvoiceItem(("Orange"), new BigDecimal("5")));
        mStoreItems.put("Strawberry", DomainFactory.newInvoiceItem(("Strawberry"), new BigDecimal("3.98")));
    }
