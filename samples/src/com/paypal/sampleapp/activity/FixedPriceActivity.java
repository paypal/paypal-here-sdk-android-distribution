 ...
 */
public class FixedPriceActivity extends MyActivity implements PeripheralsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mShoppingCart = PayPalHereSDK.getTransactionManager().beginPayment(mFixedPriceVal);
